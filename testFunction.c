...
int main(int argc, char const *argv[]) {
   ...
   // char sms1[MAX_LENGTH]="Je suis le sms de test";
    char sms2[MAX_LENGTH]="Je suis le sms de test numero 2. On va voir si ça fonctionne.";
//    menu();
    saveSMS(sms2);
