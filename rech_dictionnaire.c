...
Programme créé par Ludovic Barbier
...
void Menu(Mot **tab)
{
	...
	do{
	printf("-------------------------------------------------------------\n");
	printf("Recherche de mot dans un dictionnaire\n");
	printf("-------------------------------------------------------------\n");
	printf("Choix :\n");
	...
	default:
		printf("Entrée érronée \n");
		break;
	};
	printf("Continuer ? (oui/non) \n" );  
 	scanf("%s", choix2); 
	}while( strcmp(choix2, "oui") == 0 || strcmp(choix2, "o") == 0 || strcmp(choix2, "yes") == 0);
}
